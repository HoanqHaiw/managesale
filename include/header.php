...
<header class="header">
    ...
    <a href="help.php" class="header__navbar-item-link">
...
<?php endif; ?>
    ...
    <?php if (isset($_SESSION["user_id"])): // Nếu đã đăng nhập ?>
        <li class="header__navbar-item header__navbar-user">
                            ...
                            <span class="header__navbar-user-name"><?php echo $_SESSION["fullname"]; ?></span>
    ...
    <?php else: // Nếu chưa đăng nhập ?>
        <li class="header__navbar-item header__navbar-item--strong">
            <a href="./Register/register.php" class="header__navbar-item-link">Đăng Ký</a>
        </li>
        <li class="header__navbar-item header__navbar-item--strong header__navbar-item--separate">
            <a href="./Register/Login.php" class="header__navbar-item-link">Đăng Nhập</a>
        </li>
    <?php endif; ?>
</ul>
                ...
                <div class="header-with-search">
                    ...
                    <div class="header__search">
                        ...
                        <div class="header__search-select">
                            ...
                            <i class="header__search-select-icon fa-solid fa-arrow-down"></i>
